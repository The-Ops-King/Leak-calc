...
<tr><td style="padding:6px 24px 0;font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;">
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f7f9f7;border:1px solid #d9e5dd;border-radius:8px;">
<tr><td style="padding:20px;">
<p style="margin:0 0 8px;font-size:16px;font-weight:600;color:${INK};">If you would rather hire someone to fix it</p>
<p style="margin:0 0 16px;font-size:14px;line-height:1.6;color:${MUTED};">This is the work I do. I build the routing, the ownership and the automation that takes the human step out of the first touch, so the clock never waits on somebody noticing. If you would rather hand that over than work through it yourself, that is what I am for.</p>
<a href="https://jtylerray.com/card" style="display:inline-block;background:${ACCENT};color:#ffffff;text-decoration:none;font-size:15px;font-weight:600;padding:13px 22px;border-radius:6px;">Hire me</a>
</td></tr></table>
</td></tr>

<tr><td style="padding:22px 24px 28px;font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;">
<p style="margin:0;font-size:12px;line-height:1.6;color:${MUTED};">These are estimates from published averages (Velocify, MIT/Oldroyd, Harvard Business Review), applied to the numbers you entered. Your business is not an average. Use this to size the problem, not to forecast a quarter.</p>
<p style="margin:10px 0 0;font-size:12px;color:${MUTED};">J. Tyler Ray &middot; <a href="https://jtylerray.com/card" style="color:${ACCENT};">jtylerray.com/card</a></p>
  ...
  const text = [
    ...
    ``,
    `IF YOU WOULD RATHER HIRE SOMEONE TO FIX IT`,
    `This is the work I do. I build the routing, the ownership and the automation that takes the human step out of the first touch, so the clock never waits on somebody noticing. If you would rather hand that over than work through it yourself, that is what I am for.`,
    ``,
    `Hire me: https://jtylerray.com/card`,
    ``,
